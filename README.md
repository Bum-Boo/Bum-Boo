...
<img src="assets/research-os.svg" width="100%" alt="A research process from everyday friction to a useful change" />
...
<img src="assets/research-orbit-map.svg" width="100%" alt="A research map connecting AI, cognition, development, design, tools, media, play, and daily life" />
...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="https://github.com/Bum-Boo/hermes-skill-library"><img src="lab/public/assets/experiment-material-loop-poster.webp" width="100%" alt="Paper, film, and copper wire arranged as a material study" /></a>
      <h3><a href="https://github.com/Bum-Boo/hermes-skill-library">Hermes Skill Library</a></h3>
      <p>Reusable skills for turning Hermes Agent into a practical collaborator with explicit scope and grounded procedures.</p>
    </td>
    <td width="50%" valign="top">
      <a href="https://github.com/Bum-Boo/BIGLOADER-with-Ai-agent"><img src="lab/public/assets/experiment-bigloader-relay-poster.webp" width="100%" alt="Copper windings and a mechanical relay on a workbench" /></a>
      <h3><a href="https://github.com/Bum-Boo/BIGLOADER-with-Ai-agent">BIGLOADER with AI Agent</a></h3>
      <p>A Windows media workspace designed for useful content operations without requiring a developer-facing pipeline.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="https://github.com/Bum-Boo/agent-change-gate"><img src="lab/public/assets/experiment-change-gate-poster.webp" width="100%" alt="A manual review gate made from metal, paper, and translucent film" /></a>
      <h3><a href="https://github.com/Bum-Boo/agent-change-gate">Agent Change Gate</a></h3>
      <p>A review-before-write interface that makes agent changes inspectable, scoped, and reversible.</p>
    </td>
    <td width="50%" valign="top">
      <a href="https://github.com/Bum-Boo/hermes-desktop-korean"><img src="lab/public/assets/experiment-language-hanji-poster.webp" width="100%" alt="Bound Korean paper, thread, and proofreading marks" /></a>
      <h3><a href="https://github.com/Bum-Boo/hermes-desktop-korean">Hermes Desktop Korean</a></h3>
      <p>Korean localization treated as access design, backed by automated coverage and type verification.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="https://github.com/Bum-Boo/BBCC"><img src="lab/public/assets/experiment-bbcc-sukajan-poster.webp" width="100%" alt="Worn burgundy satin, embroidery thread, and a metal zipper" /></a>
      <h3><a href="https://github.com/Bum-Boo/BBCC">BBCC</a></h3>
      <p>Controller shortcuts that turn repeated creative and media actions into physical memory.</p>
    </td>
    <td width="50%" valign="top">
      <a href="https://github.com/Bum-Boo/BTS_sec"><img src="lab/public/assets/experiment-bts-tiger-v2-poster.webp" width="100%" alt="Layered paper stripes, thread, and flat cut shapes" /></a>
      <h3><a href="https://github.com/Bum-Boo/BTS_sec">BTS Sec</a></h3>
      <p>Defensive review utilities for web and local projects that are explicitly authorized.</p>
    </td>
  </tr>
</table>
...
<img src="assets/lab-status.svg" width="100%" alt="A generated studio note showing current public repository activity" />
